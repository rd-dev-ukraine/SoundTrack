...
interface LoginComponentState extends FormState<LoginCredentials> {
}

const defaultState = (): LoginComponentState => ({
    email: {
        value: "",
        label: "E-mail",
        type: "email",
...
export class LoginComponent extends React.Component<LoginComponentProps, LoginComponentState> {
        ...
        return (
            ...
            >
                <View style={formStyles.form}>
                    ...
                    {
                        Object.keys(this.state).map((field: keyof LoginComponentState, index) => (
                            <FormControl
                                key={index}
    ...
    handleControlChange(value: string, controlName: keyof LoginComponentState) {
